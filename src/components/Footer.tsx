...
export const Footer: FC = () => {
	...
	if (state.succeeded) {
		return (
			<h1 className="md:text-5xl/tight my-4 max-w-lg font-medium text-white">
		...
		<footer className="bg-default-950/40 backdrop-blur-3xl ">
		  <div className="container py-20 lg:px-20 ">
			  <div className="grid grid-cols-2 gap-10 lg:grid-cols-12 lg:gap-16">
				  <div className="col-span-2 sm:col-span-1 lg:col-span-3">
					  <ul className="flex flex-col gap-3">
						  <h5 className="text-default-200 mb-2 font-medium lg:text-lg xl:text-xl">About Us</h5>
							{
								menuOne.map((item, index) => (
									<li key={index}>
									  <a href="#" className="text-default-300 text-base transition-all hover:text-white">
										  <i data-lucide="gauge-circle" className="me-2 inline-block w-4 h-4">
											</i>	
											{item}
										</a>
									</li>
					...
					<div className="col-span-2 lg:col-span-6">
					  <div className="bg-primary/20 rounded-xl">
						  <div className="p-10">
							  <h6 className="mb-4 text-xl text-white">NewLetter</h6>
								<p className="text-default-200 mb-6 text-base font-medium">
								  Daftar dan dapatkan tips terbaru! 💞
								</p>
								...
								<form onSubmit={handleSubmit} className="mb-6 space-y-2">
								  <label htmlFor="email" className="text-base text-white">Email</label>
									...
									<div className="relative">
									  <input className="bg-default-950/60 pe-40 ps-4 h-12 w-full rounded-lg border-white/10 text-white py-4 backdrop-blur-3xl focus:ring-0 focus:border-white/10" type="email" id="email" name="email" />
									  <button
										  type="submit"
			...
			<div className="border-t border-white/10 py-6">
			  <div className="md:text-start container h-full flex flex-wrap items-center justify-center text-center gap-4 lg:px-20 md:justify-between">
