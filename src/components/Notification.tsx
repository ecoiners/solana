...
const Notification = ({type, message, description, txid, onHide}) => {
	...
	return (
		<div className="bg-bkg-1 pointer-events-auto z-50 mx-4 mt-2 mb-12 w-full max-w-sm overflow-hidden rounded-md pink p-2 shadow-lg right-1">
		  <div className="p-4">
			  <div className="flex items-center">
				  <div className="flex-shrink-0">
							...
							txid ? (
								<div className="flex flex-row">
								  <a href={'https://explorer.solana.com/tx' + txid + `?cluster=${networkConfiguration}`}
									  target="_blank" rel="noreferrer" className="link-accent link flex flex-row"
									>
									  <NotificationSVG/>
					...
					<div className="ml-4 flex flex-shrink-0 self-start">
					  <button className="pink rounded-md default-transition inline-flex hover:text-green-600" onClick={() => onHide()}>
